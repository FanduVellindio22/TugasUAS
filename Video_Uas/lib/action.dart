...
class _ActionScreenState extends State<ActionScreen> {
  ...
  Future<List<dynamic>> _fetchData() async {
    final url = Uri.parse('http://teknologi22.xyz/project_api/api_fandu/api_action.php?action=get');
  ...
  Future<void> _deleteData(String id) async {
    final url = Uri.parse(
        'https://teknologi22.xyz/project_api/api_fandu/api_action.php?action=delete&id=$id');
    final response = await http.get(url);
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () async {
              final url = Uri.parse(
                  'https://teknologi22.xyz/project_api/api_fandu/api_action.php?action=${id == null ? 'add' : 'update'}');
